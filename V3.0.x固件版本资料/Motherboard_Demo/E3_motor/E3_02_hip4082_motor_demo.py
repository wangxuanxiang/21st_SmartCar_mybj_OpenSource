...
# ------------------------------------------------------------------------------
motor_1 = MOTOR_CONTROLLER(MOTOR_CONTROLLER.PWM_C30_PWM_C31, 13000, duty = 0, invert = False)
motor_2 = MOTOR_CONTROLLER(MOTOR_CONTROLLER.PWM_C28_PWM_C29, 13000, duty = 0, invert = True)
motor_3 = MOTOR_CONTROLLER(MOTOR_CONTROLLER.PWM_D4_PWM_D5  , 13000, duty = 0, invert = False)
motor_4 = MOTOR_CONTROLLER(MOTOR_CONTROLLER.PWM_D6_PWM_D7  , 13000, duty = 0, invert = True)
